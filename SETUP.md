# Getting Started: ZICTA Training Repository
**Complete these steps BEFORE the Geospatial Session**

This repository contains all training materials, datasets, and R scripts for the ZICTA R Training Programme. You will need to *clone* (download) it to your computer to participate.
...
3. Accept the invitation email from the ZICTA GitHub organisation

You will receive an invitation to: `github.com/[ZICTA-ORG]`
...
ls
```
You should see: `Datasets/`, `Modules/`, `Facilitation Guides/`, `README.md`, `SETUP.md`, `ZICTA_training.Rproj`
...
Your capstone output goes in: `Capstone/[YourGroup]/`
...
**"ZICTA_training.Rproj not found"** — Run `git pull` to make sure you have the latest version of the repository.
